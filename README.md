...
* Example use cases
  * Quantifying CNN spatial priors (see [second half of quickstart]([https://bit.ly/3fghqVu](https://github.com/greydanus/mnist1d/blob/master/notebooks/1.%20quickstart.ipynb)))
